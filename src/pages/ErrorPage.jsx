...
const ErrorPage = () => {
  ...
  const imageUrl =
    "https://imgs.search.brave.com/iniBI8uw7ujIxy-HwCkf_XRuquuozHVerppuZAWlTng/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/cHJlbWl1bS12ZWN0/b3IvcGFnZS1mb3Vu/ZC00MDQtZXJyb3It/Y29uY2VwdC1pbGx1/c3RyYXRpb25fMjcw/MTU4LTI5NC5qcGc_/c2VtdD1haXNfaHli/cmlkJnc9NzQwJnE9/ODA";
  ...
  return (
    <div className="bg-slate-900 min-h-screen flex flex-col items-center justify-center text-center text-white font-sans p-4">
      ...
      <button
        className="cursor-pointer px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition-colors duration-300 mt-5"
        onClick={handleClick}
      >
        Go Back
      </button>
